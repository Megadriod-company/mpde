...
async def predict_single_url(
    ...
    try:
        ...
        # 2. Construct the standardized response
        ...
        # 3. Enterprise Logging: Save to DB in the background to prevent API latency
        background_tasks.add_task(log_prediction_to_db, response)
